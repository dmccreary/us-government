...
Test your understanding of presidential powers, the relationship between the executive and legislative branches, and the evolution of the modern presidency with these review questions.

---

#### 1. Which of the following is an enumerated power of the president found in the Constitution?
...
??? question "Show Answer"
    The correct answer is **C**. The Constitution provides that if the president does not sign or veto a bill within ten days (excluding Sundays) while Congress is in session, it becomes law automatically. However, if Congress adjourns during that ten-day window, the president can kill the bill simply by doing nothing—a pocket veto. Congress cannot override a pocket veto because it is not in session to do so. A standard veto returns the bill with objections and can be overridden by two-thirds of each chamber.

    **Concept Tested:** Pocket Veto
...
#### 5. Presidential signing statements are used by presidents to do what?
...
#### 7. Executive orders carry the force of law but differ from legislation primarily because they can be what?
...
??? question "Show Answer"
    The correct answer is **C**. Executive orders are directives issued by the president to federal agencies that carry the force of law within the executive branch, but they differ from legislation in a critical way: a subsequent president can revoke or modify them unilaterally without congressional approval. This makes executive orders politically significant but institutionally fragile. Presidents frequently revoke their predecessors' executive orders on Day One. Courts can also invalidate executive orders that exceed the president's authority or violate the Constitution.

    **Concept Tested:** Executive Orders

---

#### 8. The Twenty-Fifth Amendment to the Constitution addresses what situation?
...
??? question "Show Answer"
    The correct answer is **B**. The Twenty-Fifth Amendment (1967) was enacted after concerns raised by President Kennedy's assassination and President Eisenhower's illnesses. It establishes procedures for: filling a vacant vice presidency, presidential succession if the president dies or resigns, and—most controversially—temporarily or permanently transferring power when the president is unable to discharge their duties. The two-term limit on the presidency is the Twenty-Second Amendment (1951).

    **Concept Tested:** Presidential Succession
...
??? question "Show Answer"
    The correct answer is **B**. Modern presidents who effectively use informal powers—particularly the bully pulpit (using public communication to shape opinion and pressure Congress), executive agreements, and agenda-setting through media—tend to achieve more domestic policy success. Theodore Roosevelt coined the term "bully pulpit" to describe the presidency as a platform for moral and political leadership. Congressional responsiveness to constituent pressure means that presidents who can mobilize public opinion gain negotiating leverage that purely formal powers cannot supply.

    **Concept Tested:** Informal Presidential Powers
