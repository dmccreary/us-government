...
document.addEventListener('DOMContentLoaded', function () {
    const groups = new vis.DataSet([
        { id: 'court',  content: 'Court Decisions' },
        { id: 'leg',    content: 'Legislation / Events' }
    ]);

    const items = [
        // Court decisions (purple)
        { id: 1, group: 'court', cat: 'case', ap: true,
        ...
        { id: 2, group: 'court', cat: 'case', ap: true,
        ...
        { id: 3, group: 'court', cat: 'case', ap: false,
        ...
        { id: 4, group: 'court', cat: 'case', ap: false,
        ...
        { id: 5, group: 'court', cat: 'case', ap: false,
        ...
        { id: 6, group: 'court', cat: 'case', ap: false,
        ...
        { id: 7, group: 'court', cat: 'case', ap: false,
        ...
        { id: 8, group: 'court', cat: 'case', ap: false,
        ...
        { id: 9, group: 'court', cat: 'case', ap: false,
        ...
        { id: 10, group: 'court', cat: 'case', ap: false,
        ...
        { id: 21, group: 'leg', cat: 'event', ap: false,
        ...
        { id: 22, group: 'leg', cat: 'event', ap: false,
        ...
        { id: 23, group: 'leg', cat: 'event', ap: false,
        ...
        { id: 24, group: 'leg', cat: 'legislation', ap: false,
        ...
        { id: 25, group: 'leg', cat: 'event', ap: false,
        ...
        { id: 26, group: 'leg', cat: 'legislation', ap: false,
        ...
        { id: 27, group: 'leg', cat: 'legislation', ap: false,
        ...
        { id: 28, group: 'leg', cat: 'legislation', ap: false,
    ...
    const options = {
        ...
        zoomable: false,
        align: 'center',
        groupOrder: function (a, b) { return a.id === 'court' ? -1 : 1; }
    };
