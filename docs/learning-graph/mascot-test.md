...
The bordered thumbnails below help verify that transparency is clean and
padding has been trimmed. Each image should fill its box edge-to-edge
with no large white margins.

<div style="display:flex; gap:1rem; flex-wrap:wrap; margin-top:1rem;">
  <div style="text-align:center;">
    <img src="../../img/mascot/neutral.png" style="width:90px;height:90px;border:2px solid #546e7a;object-fit:contain;" alt="neutral">
    <p style="font-size:.75rem;">neutral</p>
  </div>
  <div style="text-align:center;">
    <img src="../../img/mascot/welcome.png" style="width:90px;height:90px;border:2px solid #1565c0;object-fit:contain;" alt="welcome">
    <p style="font-size:.75rem;">welcome</p>
  </div>
  <div style="text-align:center;">
    <img src="../../img/mascot/thinking.png" style="width:90px;height:90px;border:2px solid #4e342e;object-fit:contain;" alt="thinking">
    <p style="font-size:.75rem;">thinking</p>
  </div>
  <div style="text-align:center;">
    <img src="../../img/mascot/tip.png" style="width:90px;height:90px;border:2px solid #00897b;object-fit:contain;" alt="tip">
    <p style="font-size:.75rem;">tip</p>
  </div>
  <div style="text-align:center;">
    <img src="../../img/mascot/warning.png" style="width:90px;height:90px;border:2px solid #c62828;object-fit:contain;" alt="warning">
    <p style="font-size:.75rem;">warning</p>
  </div>
  <div style="text-align:center;">
    <img src="../../img/mascot/encouraging.png" style="width:90px;height:90px;border:2px solid #e65100;object-fit:contain;" alt="encouraging">
    <p style="font-size:.75rem;">encouraging</p>
  </div>
  <div style="text-align:center;">
    <img src="../../img/mascot/celebration.png" style="width:90px;height:90px;border:2px solid #1a237e;object-fit:contain;" alt="celebration">
    <p style="font-size:.75rem;">celebration</p>
  </div>
</div>
